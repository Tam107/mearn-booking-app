                ...
                <div className='w-9/11 mx-auto'>
                    <div className='w-full aspect-[4/3] relative pt-10 pb-14'>
                        <div className='flex h-full gap-10 items-start justify-between'>
                            <div className='flex flex-col gap-6 pt-11 w-[40%]'>
                                <h2 className='font-[500] text-[72px] leading-[80px] text-[#111827]'>
                                    Highlights of Vietnam
                                </h2>
                                <p className='font-[400] text-[18px] leading-[28px] text-[#6B7280]'>
                                    Accompanying us, you have a trip full of experiences. With us, booking accommodation, hotels, cruises, train, bus ticket
                                </p>
                                <div className='py-[13px] gap-[10px] font-[500] text-[16px] leading-[24px] w-fit text-white px-[25px] rounded-full flex items-center justify-center bg-[#4F46E5]'>
                        ...
                        <div className='absolute bottom-16 left-0 w-full'>
                            <div className='flex w-[30%] flex-row-reverse gap-4 items-center'>
                                <div>
                                    <p className='text-[#9CA3AF] font-medium text-[16px] leading-[24px]'>Rental car</p>
                                </div>
                                <div className='flex gap-1 items-center justify-between'>
                                    <div className='w-[10px] h-[10px] rounded-full bg-black'></div>
                                    <p className='text-[#1F2937] font-medium text-[16px] leading-[24px]'>Bus & Shuttle</p>
                                </div>
                                <div>
                                    <p className='text-[#9CA3AF] font-medium text-[16px] leading-[24px]'>Stays</p>
                                </div>
                            </div>
                            <br />
                            <div className='w-full'>
                                <div className='w-[90%] py-2 pr-3 flex items-center rounded-[130px] px-1 shadow-lg bg-[#FFFFFFCC]'>
                                    <div className='flex-1 flex sm:flex-row flex-col items-center justify-between'>
                                        {/* From */}
                                        <div className='flex sm:w-[25%] w-full items-center justify-center py-2 px-3'>
                                            <div className='flex items-center gap-3'>
                                                <CiLocationOn color='#D1D5DB' size={25}/>
                                                <div className='flex flex-col gap-1'>
                                                    <h2 className='font-[600] text-[18px] leading-[28px]'>From</h2>
                                                    <p className='text-[#9CA3AF] text-[14px]'>Where are you?</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className='flex sm:w-[25%] w-full items-center justify-center py-2 px-3'>
                                            <div className='flex items-center gap-3'>
                                                ...
                                                <div className='flex flex-col gap-1'>
                                                    ...
                                                    <p className='text-[#9CA3AF] text-[14px]'>Where are you going?</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className='flex sm:w-[25%] w-full items-center justify-center py-2 px-3'>
                                            <div className='flex items-center gap-3'>
                                                ...
                                                <div className='flex flex-col gap-1'>
                                                    ...
                                                    <p className='text-[#9CA3AF] text-[14px]'>Add date</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className='flex sm:w-[25%] w-full items-center justify-center py-2 px-3'>
                                            <div className='flex items-center gap-3'>
                                                ...
                                                <div className='flex flex-col gap-1'>
                                                    ...
                                                    <p className='text-[#9CA3AF] text-[14px]'>Add guests</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    {/* Search Button */}
                                    <div className='bg-[#4F46E5] w-[48px] h-[48px] shadow-sm rounded-full flex items-center justify-center z-50'>
